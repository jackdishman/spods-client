<template>
  <section class="text-white">
    <h1>Privacy Policy for spods.app</h1>

    <p>
      At spods, accessible from https://spods.app, one of our main priorities is
      the privacy of our visitors. This Privacy Policy document contains types
      of information that is collected and recorded by spods and how we use it.
    </p>
    ...
    <p>
      ...
      and/or collect in spods. This policy is not applicable to any information
    ...
    <p>
      spods follows a standard procedure of using log files. These files log
    ...
    <P
      ...
      advertising partners of spods.</P
    >

    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on spods, which are sent directly to
    ...
    <p>
      Note that spods has no access to or control over these cookies that are
    ...
    <p>
      spods's Privacy Policy does not apply to other advertisers or websites.
    ...
    <p>
      spods does not knowingly collect any Personal Identifiable Information
