<template>
  ...
  <div>
    ...
    <!-- component -->
    <div class="p-20 h-screen w-screen flex flex-col-reverse md:flex-row items-center justify-center bg-color-light">
      <div class="content text-3xl text-center md:text-left">
        <h1 class="text-5xl text-green-500 font-bold spods">spods</h1>
        <p>Putting people on the blockchain.</p>
      </div>
      <div class="container mx-auto flex flex-col items-center">
        <form class="shadow-lg w-80 p-4 bg-white rounded-lg">
          <UserAuthForm />
        ...
        <p class="text-center text-sm my-4">
          <span class="font-semibold text-center w-full">Create a Page</span> for creators or enterprises
        </p>
      </div>
    </div>
