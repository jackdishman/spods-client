<template>
  <section class="text-white">
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          this Agreement) refers to spods.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to spods, accessible from
          <a
            href="https://www.spods.app"
            rel="external nofollow noopener"
            target="_blank"
            >https://www.spods.app</a
          >
        </p>
      </li>
      <li>
    ...
    <ul>
      <li>
        <p>By email: me@jackdishman.com</p>
      </li>
      <li>
        <p>By phone number: 6172719070</p>
      </li>
    </ul>
  </section>
</template>
